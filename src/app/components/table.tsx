...
export function TabelaPessoas() {
  ...
  const columns: ColumnDef<Pessoa>[] = React.useMemo(() => [
    ...
    { accessorKey: "igrejaBatizado", header: "Igreja Batismo" }, { accessorKey: "dtAdmissao", header: "Data da Admissão" },
    { accessorKey: "tipoAdmissao", header: "Tipo Admissão" }, { accessorKey: "dtConversao", header: "Data da Conversão" },
    { accessorKey: "gfcdFrequentado", header: "GFCD" }, 
    { accessorKey: "gfcdConsolidado", header: "Já foi consolidado?", cell: ({ row }) => (row.getValue("gfcdConsolidado") ? "Sim" : "Não") },
    { accessorKey: "nomeConsolidador", header: "Consolidador por" }, { accessorKey: "retiro", header: "Retiro" },
    {
      id: "actions",
      header: "Ações",
      cell: ({ row }) => (
